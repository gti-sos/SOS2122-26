<main>
    <h1 style="font-weight: bold;">SOS2122-26</h1>
    ...
    <ul>
        ...
        <li>
            - <a href="https://github.com/brico1994">
                [Bruno Alvaro Rico Barrilero]
            </a>
        </li>
    </ul>
    <p style="font-weight: bold;">
        - Project description: </p>Estudio y análisis de la relación entre el gasto público en defensa, generación energética e indice de desarrollo
